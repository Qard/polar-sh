...
module Polar
  module Models
    # Model representing a BenefitGitHubRepositorySubscriber
    #
    # This struct is auto-generated from the Polar.sh OpenAPI specification.
    # It uses `JSON::Serializable` for automatic JSON parsing and serialization.
    struct BenefitGitHubRepositorySubscriber
      ...
      getter properties : BenefitGitHubRepositorySubscriberProperties
    end
  end
end
