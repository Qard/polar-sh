...
module Polar
  module Models
    # Model representing a CustomerBenefitGrantCustom
    #
    # This struct is auto-generated from the Polar.sh OpenAPI specification.
    # It uses `JSON::Serializable` for automatic JSON parsing and serialization.
    struct CustomerBenefitGrantCustom
      ...
      getter benefit : BenefitCustomSubscriber

      @[JSON::Field(key: "properties")]
      getter properties : BenefitGrantCustomProperties
    end
  end
end
