...
module Polar
  module Models
    # Model representing a CustomerBenefitGrantDownloadables
    #
    # This struct is auto-generated from the Polar.sh OpenAPI specification.
    # It uses `JSON::Serializable` for automatic JSON parsing and serialization.
    struct CustomerBenefitGrantDownloadables
      ...
      getter benefit : BenefitDownloadablesSubscriber

      @[JSON::Field(key: "properties")]
      getter properties : BenefitGrantDownloadablesProperties
    end
  end
end
