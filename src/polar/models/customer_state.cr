...
module Polar
  module Models
    # Model representing a CustomerState
    #
    ...
    struct CustomerState
      ...
      getter active_subscriptions : Array(CustomerStateSubscription)

      # The customer's active benefit grants.
      @[JSON::Field(key: "granted_benefits")]
      getter granted_benefits : Array(CustomerStateBenefitGrant)

      # The customer's active meters.
      @[JSON::Field(key: "active_meters")]
      getter active_meters : Array(CustomerStateMeter)
