...
module Polar
  module Models
    # Model representing a CustomerBenefitGrantDiscord
    #
    # This struct is auto-generated from the Polar.sh OpenAPI specification.
    # It uses `JSON::Serializable` for automatic JSON parsing and serialization.
    struct CustomerBenefitGrantDiscord
      ...
      getter benefit : BenefitDiscordSubscriber

      @[JSON::Field(key: "properties")]
      getter properties : BenefitGrantDiscordProperties
    end
  end
end
