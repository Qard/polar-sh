...
module Polar
  module Models
    # Model representing a CustomerBenefitGrantGitHubRepository
    #
    # This struct is auto-generated from the Polar.sh OpenAPI specification.
    # It uses `JSON::Serializable` for automatic JSON parsing and serialization.
    struct CustomerBenefitGrantGitHubRepository
      ...
      getter benefit : BenefitGitHubRepositorySubscriber

      @[JSON::Field(key: "properties")]
      getter properties : BenefitGrantGitHubRepositoryProperties
    end
  end
end
