...
module Polar
  module Models
    # Model representing a CustomerBenefitGrantMeterCredit
    #
    # This struct is auto-generated from the Polar.sh OpenAPI specification.
    # It uses `JSON::Serializable` for automatic JSON parsing and serialization.
    struct CustomerBenefitGrantMeterCredit
      ...
      getter benefit : BenefitMeterCreditSubscriber

      @[JSON::Field(key: "properties")]
      getter properties : BenefitGrantMeterCreditProperties
    end
  end
end
