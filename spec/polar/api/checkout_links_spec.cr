...
describe Polar::Api::CheckoutLinks do
  it "has accessor method on client" do
    client = Polar::Client.new
    client.checkout_links.should be_a(Polar::Api::CheckoutLinks)
  end

  it "has list method" do
    client = Polar::Client.new
    api = client.checkout_links
