...
describe Polar::Api::Checkouts do
  it "has accessor method on client" do
    client = Polar::Client.new
    client.checkouts.should be_a(Polar::Api::Checkouts)
  end

  it "has list method" do
    client = Polar::Client.new
    api = client.checkouts
  ...
  it "has client_get method" do
    client = Polar::Client.new
    api = client.checkouts
    api.responds_to?(:client_get).should be_true
  end

  it "has client_update method" do
    client = Polar::Client.new
    api = client.checkouts
    api.responds_to?(:client_update).should be_true
  end

  it "has client_confirm method" do
    client = Polar::Client.new
    api = client.checkouts
    api.responds_to?(:client_confirm).should be_true
  end

  # Integration tests - run with POLAR_ACCESS_TOKEN set
  describe "integration", tags: "integration" do
    it "List Checkout Sessions" do
